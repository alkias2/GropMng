...
public class OwnerAuthController : Controller
{
	...
	[HttpPost("login", Name = "Owner.Auth.Login.Post")]
	...
	[HttpGet("register", Name = "Owner.Auth.Register")]
	...
	[HttpPost("register", Name = "Owner.Auth.Register.Post")]
	[ValidateAntiForgeryToken]
	public async Task<IActionResult> Register(OwnerRegisterModel model, CancellationToken cancellationToken)
	{
		...
		try
		{
			...
			{
				var link = Url.Action(nameof(ConfirmEmail), "OwnerAuth", new { email = result.Owner.Email, token = result.EmailConfirmationToken }, Request.Scheme);
	...
	[HttpGet("confirm-email", Name = "Owner.Auth.ConfirmEmail")]
	...
	[HttpGet("forgot-password", Name = "Owner.Auth.ForgotPassword")]
	public IActionResult ForgotPassword()
	{
		return View(new OwnerForgotPasswordModel());
	}

	[HttpPost("forgot-password", Name = "Owner.Auth.ForgotPassword.Post")]
	[ValidateAntiForgeryToken]
	...
	[HttpGet("reset-password", Name = "Owner.Auth.ResetPassword")]
	...
	[HttpPost("reset-password", Name = "Owner.Auth.ResetPassword.Post")]
	[ValidateAntiForgeryToken]
	...
	[Authorize]
	[HttpPost("logout", Name = "Owner.Auth.Logout")]
	[ValidateAntiForgeryToken]
